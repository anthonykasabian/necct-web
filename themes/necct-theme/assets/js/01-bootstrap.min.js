...
!function (t, e) {
    ...
    var ye = "tooltip", Ee = "bs.tooltip", Ce = "." + Ee, Te = g.fn[ye], Se = "bs-tooltip",
        be = new RegExp("(^|\\s)" + Se + "\\S+", "g"), Ie = {
            animation: "boolean",
            template: "string",
        ...
        }, ke = "fade", Pe = "show", Le = ".tooltip-inner", je = ".arrow", He = "hover", Re = "focus", Ue = "click",
        We = "manual", xe = function () {
            function i(t, e) {
    ...
    var Fe = "popover", qe = "bs.popover", Me = "." + qe, Ke = g.fn[Fe], Qe = "bs-popover",
        Be = new RegExp("(^|\\s)" + Qe + "\\S+", "g"), Ve = l({}, xe.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Ye = l({}, xe.DefaultType, {content: "(string|element|function)"}), Xe = "fade", ze = "show",
        Ge = ".popover-header", Je = ".popover-body", Ze = {
            HIDE: "hide" + Me,
            HIDDEN: "hidden" + Me,
            SHOW: "show" + Me,
            SHOWN: "shown" + Me,
    ...
    var tn = "scrollspy", en = "bs.scrollspy", nn = "." + en, on = g.fn[tn],
        ...
        ln = "dropdown-item", cn = "active", hn = '[data-spy="scroll"]', un = ".nav, .list-group", fn = ".nav-link",
        dn = ".nav-item", gn = ".list-group-item", _n = ".dropdown", mn = ".dropdown-item", pn = ".dropdown-toggle",
        vn = "offset", yn = "position", En = function () {
            function n(t, e) {
                var n = this;
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? vn : yn,
                    o = "auto" === this._config.method ? t : this._config.method, r = o === yn ? this._getScrollTop() : 0;
    ...
    var Cn = "bs.tab", Tn = "." + Cn, Sn = g.fn.tab, bn = {
            HIDE: "hide" + Tn,
            HIDDEN: "hidden" + Tn,
            SHOW: "show" + Tn,
            SHOWN: "shown" + Tn,
            CLICK_DATA_API: "click" + Tn + ".data-api"
        }, In = "dropdown-menu", Dn = "active", wn = "disabled", An = "fade", Nn = "show", On = ".dropdown",
        kn = ".nav, .list-group", Pn = ".active", Ln = "> li > .active",
        jn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Hn = ".dropdown-toggle",
        Rn = "> .dropdown-menu .active", Un = function () {
            function i(t) {
                this._element = t
            }
            ...
            return t.show = function () {
                ...
                var i = this, o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(Pn) : g(e).find(Ln))[0],
                    r = n && o && g(o).hasClass(An), s = function () {
    ...
    var Wn = "toast", xn = "bs.toast", Fn = "." + xn, qn = g.fn[Wn], Mn = {
            CLICK_DISMISS: "click.dismiss" + Fn,
            HIDE: "hide" + Fn,
            HIDDEN: "hidden" + Fn,
            SHOW: "show" + Fn,
            SHOWN: "shown" + Fn
        }, Kn = "fade", Qn = "hide", Bn = "show", Vn = "showing",
        Yn = {animation: "boolean", autohide: "boolean", delay: "number"},
        Xn = {animation: !0, autohide: !0, delay: 500}, zn = '[data-dismiss="toast"]', Gn = function () {
            function i(t, e) {
